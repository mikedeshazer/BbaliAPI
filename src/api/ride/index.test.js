...
test('POST /rides 201 (user)', async () => {
  const { status, body } = await request(app())
    .post(`${apiRoot}`)
    .send({ access_token: userSession, timeStarted: 'test', type: 'test', duration: 'test', ratePerUnitTime: 'test', currency: 'test', timeEnded: 'test', paymentMethodID: 'test', status: 'test', rideTotal: 'test', locationPickupLon: 'test', locationPickupLat: 'test', locationdropOffLon: 'test', locationDropoffLat: 'test', loctionDropoffAddress: 'test' })
...
test('PUT /rides/:id 401 (user) - another user', async () => {
  const { status } = await request(app())
    .put(`${apiRoot}/${ride.id}`)
    .send({ access_token: anotherSession, timeStarted: 'test', type: 'test', duration: 'test', ratePerUnitTime: 'test', currency: 'test', timeEnded: 'test', paymentMethodID: 'test', status: 'test', rideTotal: 'test', locationPickupLon: 'test', locationPickupLat: 'test', locationdropOffLon: 'test', locationDropoffLat: 'test', loctionDropoffAddress: 'test' })
  expect(status).toBe(401)
})
